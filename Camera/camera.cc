...
int Camera::checkFrustum(const BBox *theBBox,
	...
	//1 si esta fuera del frustum, 0 si corta al firstum, -1 si esta dentro del frustum
	...
	for (int i=0; i<6; i++) {
		...
		if (interseccion == +IREJECT) {
			return 1;
		}

		//si esta dentro del plano sumamos 1, (para ver el numero de planos en los que esta dentro)
	...
	//intersecta como minimo en un plano, devolver 0
	else {
		return 0;
	}
